...
class AnnouncementCard extends StatelessWidget {
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Builder(
                        builder: (context) {
                          // Debug: Show which date field is being used
                          final publishDate = announcement.publishDate;
                          final createdAt = announcement.createdAt;
                          final displayDate = publishDate ?? createdAt;

                          print('=== ANNOUNCEMENT DATE DEBUG ===');
                          print('Announcement ID: ${announcement.id}');
                          print('Title: ${announcement.title}');
                          print('publishDate: $publishDate');
                          print('createdAt: $createdAt');
                          print('Using date: $displayDate');
                          print('=====================================');
  ...
  String _formatDate(DateTime date) {
    ...
    print('=== DATE DEBUG ===');
    print('Raw date: $date');
    print('Date ISO: ${date.toIso8601String()}');
    print('Date UTC: ${date.toUtc()}');
    print('Date local: ${date.toLocal()}');
    print('==================');
